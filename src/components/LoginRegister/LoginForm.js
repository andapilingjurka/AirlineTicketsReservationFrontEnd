      ...
      <div className="row border rounded-5 p-3 bg-white shadow box-area">
        ...
        <div className="col-md-6 right-box">
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              <Form.Control type="text" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)} className="form-control form-control-lg bg-light fs-6" />
            </Form.Group>
            <Form.Group className="mb-3">
            ...
            <div className="input-group mb-3">
              <Button variant="primary" type="submit" className="btn btn-lg w-100 fs-6" disabled={loading}>
                {loading ? 'Loading...' : 'Login'}
              </Button>
            </div>
            <div className="row">
              <small>
                Nuk keni një llogari?<Link to="/registration"> Regjistrohuni këtu</Link>
              </small>
            </div>
          </Form>
        </div>
